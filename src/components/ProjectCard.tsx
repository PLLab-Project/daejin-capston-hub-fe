...
export function ProjectCard({ project, onBookmark, onOpen }: ProjectCardProps) {
  return (
    <article className="group relative overflow-hidden rounded-[10px] border border-neutral-200 bg-white md:overflow-visible md:rounded-none md:border-0">
      ...
      <div className="relative px-2 pb-1.5 pt-[5px] md:px-[2px] md:pb-0 md:pt-1">
        ...
        <div className="mt-0.5 flex text-[9px] leading-[10px] text-neutral-400 md:-mx-[2px] md:mt-1 md:border-t md:border-neutral-200 md:px-[2px] md:pt-1 md:text-[11px] md:leading-4">
